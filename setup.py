...
setup(name='docassemble.mlhframework',
      ...
      install_requires=['docassemble.ALToolbox>=0.14.0', 'docassemble.GithubFeedbackForm @ git+https://github.com/SuffolkLITLab/docassemble-GithubFeedbackForm.git@main'],
      zip_safe=False,
