...
setup(name='docassemble.mlhframework',
      ...
      install_requires=['docassemble.ALToolbox>=0.11.1', 'docassemble.AssemblyLine @ git+https://github.com/suffolklitlab/docassemble-assemblyline.git@main'],
      zip_safe=False,
