...
setup(name='docassemble.mlhframework',
      ...
      install_requires=['docassemble.ALToolbox>=0.14.0', 'docassemble.AssemblyLine @ git+https://github.com/SuffolkLITLab/docassemble-AssemblyLine.git@bates_number_to_aldoc', 'docassemble.GithubFeedbackForm @ git+https://github.com/SuffolkLITLab/docassemble-GithubFeedbackForm.git@main'],
      zip_safe=False,
